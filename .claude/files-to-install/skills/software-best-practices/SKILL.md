...
description: Ensure code quality best practices for personal projects. Validates tests, linting, run scripts, error handling. Executes code and iterates until success.
