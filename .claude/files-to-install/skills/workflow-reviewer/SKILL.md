...
**These paths SHOULD be reviewed** (user's workflow files):
- `.claude/commands/[workflow-name].md` (user's workflow)
- `.claude/commands/setup.md` (generated by create-agent)
- `.claude/skills/[user-skills]/*` (user's custom skills)
- `.claude/agents/[user-agents].md` (user's custom agents)
- `.claude/knowledge/[user-files].md` (user's knowledge files)
- `project-plan/*` (all project planning files)
- `CLAUDE.md`, `README.md`, `.gitignore`, etc.
